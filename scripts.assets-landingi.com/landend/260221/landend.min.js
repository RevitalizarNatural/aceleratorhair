...
function saveUrlLeadIdToFormInput() {
    ...
    if (cookieValue) {
        Object.values(document.querySelectorAll('form input[name="_lead_uuid"]')).forEach(function(input) {
...
function checkUrlForActionAfterSubmission() {
    ...
    for (var key in params) {
        if (params.hasOwnProperty('lndingActnAftrSbsLd')) {
            ...
            document.cookie = 'lndingActnAftrSbsLd=' + params[key] + ';expires=' + new Date(exp) + ';path=' + window.location.pathname;
...
function registerValidateCallback(callback) {
    ...
    function validate(e) {
        ...
        var extras = {
            '_landing-hash': $form.attr('data-hash')
        };
