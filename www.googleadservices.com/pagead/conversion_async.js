(function() {
    ...
    */
            ...
            if ((h = c.domain) && "auto" === h.toLowerCase()) {
                ...
                for (var k = 0; k < h.length; ++k) {
                    var m = "none" !== h[k] ? h[k] : void 0,
                        n = d(f, "domain", m);
                    n = e(n, c.flags);
                    if (!yb(m, c.path) && ub(n, a, b, c.o)) break
                }
    ...
    function Gb(a, b) {
        var c = "query";
        if ("protocol" === c || "port" === c) a.protocol = Hb(a.protocol) || Hb(H.location.protocol);
        "port" === c ? a.port = String(Number(a.hostname ? a.port : H.location.port) || ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")) : "host" === c && (a.hostname = (a.hostname || H.location.hostname).replace(Eb, "").toLowerCase());
        var d = Hb(a.protocol);
    ...
    function Mb(a, b) {
        nb("ad_storage") ? Q() ? a() : qb(a) : b ? hb(3) : pb(function() {
            Mb(a, !0)
        })
    }
    ...
    function R(a) {
        ...
        a = rb(a, I.cookie, void 0, "ad_storage");
    ...
    function $b() {
        ...
        if ("null" !== H.origin) {
            ...
            Mb(function() {
                eb(d, function(f, g) {
                    g = rb(c + g, I.cookie, void 0, "ad_storage");
                    g.sort(function(n, p) {
                        return Yb(p) - Yb(n)
                    });
                    if (g.length) {
    ...
    function pc(a, b) {
        var c = "" !== oc(a, b) || 0 < x(Object, "keys").call(Object, Q() ? P("_gac_gb", !0) : {}).length;
        a = "" !== nc(a, b) || "" !== kc(a, Q() ? P() : {}, gc);
        return c && a
    }
    ...
    function Qc(a, b) {
        ...
        else fc.test(a.location.host) ? f = !(ic.test(a.location.href) || gc.test(a.location.href)) : (f = Math.max(bc("aw", d), cc(Q() ? P() : {})), f = Math.max(bc("gb", d), cc(Q() ? P("_gac_gb", !0) : {})) > f);
        if (f) {
        ...
        if (d) return b = nc(a, d), T("gclaw", b);
        (b = nc(a)) && (c = T("gclaw",
            b));
        b = kc(a, Q() ? P() : {}, gc);
        return c + (b ? T("gac", b) : "")
    ...
    function Uc(a, b, c, d, e, f) {
        ...
        W = Ta ? !0 === W ? T("rdp", 1) : !1 === W ? T("rdp", 0) : "" : "";
        var cd = T("value",
                d.google_conversion_value),
            dd = T("currency_code", d.google_conversion_currency),
            ed = T("label", d.google_conversion_label),
            fd = T("oid", d.google_conversion_order_id),
            gd = T("bg", d.google_conversion_color);
        a: {
        ...
        var hd = T("guid", "ON"),
            id = !d.google_conversion_domain && "GooglemKTybQhCsO" in A && "function" == typeof A.GooglemKTybQhCsO ? T("resp",
                "GooglemKTybQhCsO") : "",
            jd = T("disvt", d.google_disable_viewthrough),
            kd = T("eid", Za().join());
        ...
        G = Vc();
        var md = T("ig", /googleadservices\.com/.test("www.googleadservices.com") ? 1 : 0),
        ...
        if (c) {
            ...
            va += T("frm", r);
            va += T("url", Nc(z));
            va += T("ref", Nc(nd || c.referrer))
        }
        a = [h, k, m, n, p, q, t, C, W, cd, dd, ed, fd, gd, w, hd, id, jd, kd, X, u, b, G, md, f, ua, va, Tc(c), Wc(d.google_additional_params), Wc(d.google_remarketing_only ? {} : d.google_additional_conversion_params),
            "&hn=" + S("www.googleadservices.com"), Xc(a)
        ].join("");
        c = Wa();
        ...
        Sa && (e = Hc(), void 0 !== e && (g += T("us_privacy", e || "error")));
        Sc(d) && (g = d.l ? g + T("gbcov", 1) : g + T("gbcov", 0));
        return g
    }
    ...
    function ad(a, b) {
        F && "376635471" == Ya(2) && ("complete" === b.readyState ? Yc(b) : a.addEventListener ? a.addEventListener("load", function() {
            Yc(b)
    ...
    function rd(a, b) {
        ...
        b ? (Kc = !0, a = (a = I.featurePolicy) && bb(a.allowsFeature) ? a.allowsFeature("attribution-reporting") :
            !1) : a = !1;
        return a
    };
    var sd = !1,
    ...
    function xd(a, b, c, d) {
        ud(a, c, d);
        ab() && (wc(2), d.google_gtm && yc(K(uc), a));
        var e = !1;
        if (3 != d.google_conversion_format) return !1;
        try {
            if (bd(d)) {
                d.google_remarketing_only && d.google_enable_display_cookie_match && !Gc && F && Xa(["376635470", "376635471"], Na, 2);
                ...
                if (1 == d.google_remarketing_only && null != d.google_gtag_event_data && null != d.google_gtag_event_data.items && d.google_gtag_event_data.items.constructor === Array && 0 < d.google_gtag_event_data.items.length) yd(a, b, c, d);
                    ...
                    h = function(k, m, n) {
                        m = void 0 === m ? !0 : m;
                        n = void 0 === n ? !0 : n;
                        $c(a, c, d, Uc(a, b, c, d, k), m, n)
                    };
                    d.google_remarketing_only ? h(2) : g ? (wd(d, f ? 3 : 2), qd(a, b, c, d), h(1), h(3), f && h(6, !0, !1)) : (wd(d, f ? 2 : 1), qd(a, b, c, d), h(0), f && h(5, !0, !1), Sc(d) && pc(c, Rc(d)) && (d.l = !0, h(0, !1)))
                }
    ...
    for (var Z; V.length && (Z = V.shift());) V.length || void 0 === zd ? Y[Z] && Y[Z] !== Object.prototype[Z] ? Y = Y[Z] : Y = Y[Z] = {} : Y[Z] = zd;
